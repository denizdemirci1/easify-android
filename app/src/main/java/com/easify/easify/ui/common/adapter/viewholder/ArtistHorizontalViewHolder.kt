...
import com.easify.easify.databinding.ViewHolderEasifyArtistHorizontalBinding
...
) : BaseViewHolder<ViewHolderEasifyArtistHorizontalBinding>(
  binding = ViewHolderEasifyArtistHorizontalBinding.inflate(inflater, parent, false)
) {
